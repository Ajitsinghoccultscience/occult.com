@props([
    ...
    'convocationGallery' => [
        ['src' => 'image/graphology assests/pawan sir.webp',                     'caption' => 'Pawan Sir '],
                ...
                <div id="{{ $instSliderId }}-m" class="flex gap-3 overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-1">
                    ...
                    <div class="shrink-0 w-[80vw] snap-center relative rounded-xl overflow-hidden aspect-[4/3]">
                        <img
                            ...
                            class="w-full h-full {{ $photo['src'] === 'image/graphology assests/pawan sir.webp' ? 'object-cover object-top' : 'object-cover' }}"
                            loading="lazy"
                        >
