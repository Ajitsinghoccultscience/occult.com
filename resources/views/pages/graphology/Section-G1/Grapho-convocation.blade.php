...
<script>window.__carousels.push({id:'convo-slider',slideClass:'.convo-slide',prevId:'convo-prev',nextId:'convo-next',dotPrefix:'convo-dot-',dotActive:'#04043A',offsetPad:16,interval:2500});</script>
