@php
    $reviews = [
        ...
        ['name' => 'Dr. Anjali Mehta','role' => 'Psychologist',       'avatar' => 'images/assets desktop/Priya_Sharma.avif',  'text' => "I joined last month and learn that the pressure and slant markers actually add a real layer to my client assessments now. Practical lessons, loved it!"],
        ['name' => 'Kavita Nair',     'role' => 'School Teacher',     'avatar' => 'images/assets desktop/ishika.avif',        'text' => "I finally understand why some of my quiet students behave the way they do. Just reading their handwriting differently has changed how I guide them."],
        ['name' => 'Suresh Patel',    'role' => 'Life Coach',         'avatar' => 'images/assets desktop/Vikram_Singh.avif',  'text' => "Started offering handwriting readings as an add-on and my clients love it. It's already brought me three new referrals this month."],
        ['name' => 'Neha Gupta',      'role' => 'College Student',    'avatar' => 'image/graphology assests/alumni 2.webp',   'text' => "Had zero background in this. By the end of the course I could actually read  traits from my own writing. Simple enough for a beginner, and genuinely fun."],
