@php
    ...
    $bullets = [
        ['icon' => 'income',  'html' => 'Add Graphology as a premium skill to <strong>increase your income potential.</strong>'],
        ['icon' => 'cert',    'html' => 'Get <strong>Certificate of Participation</strong> and <strong>Bonus Worth ₹4,999</strong>'],
        ['icon' => 'shield',  'html' => 'Get more <strong>trust, value and recognition</strong> in your professional field.'],
    ];
...
<section class="bg-neutral-50 py-3 md:py-6 font-open-sans" style="width:100vw;margin-left:calc(50% - 50vw);font-family:'Open Sans',sans-serif;">
                ...
                <div class="order-2 lg:order-1">
                    ...
                    <ul class="space-y-4 mb-7 md:mb-8">
                        ...
                        <li class="flex items-start gap-3 text-neutral-b text-sm md:text-base">
                            ...
                            <span class="leading-snug">{!! $b['html'] !!}</span>
                        </li>
                        @endforeach
                    </ul>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-5">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-neutral-b font-medium mt-0.5">10k+ reviews (4.9 of 5)</p>
                            </div>
                        </div>
                    </div>
                </div>
