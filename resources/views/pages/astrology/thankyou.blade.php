            ...
            <div class="w-full flex flex-col gap-4">
                ...
                <div class="w-full rounded-2xl border-2 border-green-400 bg-green-50 p-5 flex flex-col items-center gap-4">
                    ...
                    <a href="https://chat.whatsapp.com/BhTfKJeONzQ64s8WCFZfg2"
                       ...
                       class="inline-flex items-center justify-center gap-3 w-full py-4 rounded-xl font-bold text-white text-base transition-all duration-200 hover:opacity-90 active:scale-95 shadow-md"
                ...
                <div class="w-full rounded-2xl border border-gray-200 bg-gray-50 p-5 flex items-start gap-4 text-left">
                    ...
                    <div>
                        <p class="font-bold text-gray-900 text-base">Attend Live on April 18th</p>
                        <p class="text-sm text-gray-500 mt-0.5">Join at 4:00 PM IST and decode your cosmic blueprint live</p>
                    </div>
                </div>
