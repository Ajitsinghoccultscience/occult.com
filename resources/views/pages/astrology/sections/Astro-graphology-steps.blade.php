@props([
    ...
    'steps' => [
        [
            'name' => 'Analysis',
            'icon' => 'Analysis.svg',
            'description' => 'You will be able to analyse various birth charts, planetary strengths, and divisional charts.',
        ],
        [
            'name' => 'Decode',
            'icon' => 'Decode.svg',
            'description' => 'Decode the hidden destiny, career paths, and health patterns behind the stars. Know what planetary yoga tells about success.',
        ],
        [
            'name' => 'Understand',
            'icon' => 'Understand.svg',
            'description' => 'You will be able to understand the cycles of time (Sade Sati, Dhaiya) and the mindset of individuals based on their Moon Sign.',
        ],
        [
            'name' => 'Guidance',
            'icon' => 'Guidance.svg',
            'description' => 'You will be able to guide people by suggesting planetary remedies, lifestyle changes, and timing for important life events.',
        ],
    ],
])

@php
    $title = $title ?? 'How Astrology Works';
    $steps = $steps ?? [];
