@props([
    ...
    'faqs'  => [
        [
            ...
            'answer'   => 'Yes! This course is designed for absolute beginners. No prior knowledge or experience in occult sciences is required. You ll learn everything step-by-step, from the fundamentals to advanced concepts.',
        ],
        ...
        [
            ...
            'answer'   => 'Yes! We provide career guidance, networking opportunities, and ongoing support to help you start your professional journey in the field of Occult Sciences after completing the course.',
        ],
        [
...
<section class="w-full section-spacing bg-white mb-10 py-2 md:py-8">
        ...
        <div class=" mx-auto flex flex-col gap-3" id="{{ $faqId }}">
            ...
            <div class="border border-neutral-200 rounded-2xl overflow-hidden shadow-sm" data-faq-item>
                ...
                <button
                    ...
                    <span class="font-semibold text-sm md:text-base text-black leading-snug">{{ $faq['question'] }}</span>
                ...
                <div class="{{ $i === 0 ? '' : 'hidden' }} px-5 pb-4 border-t border-neutral-100" data-faq-panel>
                    <p class="text-sm text-black leading-relaxed pt-3">{{ $faq['answer'] }}</p>
                </div>
